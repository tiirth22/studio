      ...
      <Sidebar>
        <SidebarHeader>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold font-headline text-primary-foreground">RentEase (Admin)</h1>
          </div>
        </SidebarHeader>
        <SidebarContent>
          <SidebarMenu>
            ...
            <SidebarMenuItem>
                <div className="flex items-center gap-3 p-2">
                    ...
                    <div className="flex flex-col text-sm text-primary-foreground group-data-[collapsible=icon]:hidden">
                        ...
                        <span className="text-primary-foreground/70">admin@rentease.com</span>
                    </div>
                </div>
            </SidebarMenuItem>
          </SidebarMenu>
